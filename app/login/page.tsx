  ...
  return (
    ...
    <section className="bg-[#121212] text-white h-screen w-screen flex items-center justify-center p-4">
      ...
      >
        ...
        <h1 className="text-center text-4xl font-normal mb-2">Login</h1>
        ...
        <div className="text-left">
          <a
            href="#"
            className="text-[10px] text-gray-400 uppercase font-bold tracking-wider hover:text-white transition-colors"
          >
            ESQUECEU A SENHA?
          </a>
        </div>
        ...
        {/* Seção de baixo com gap-3 entre os textos e o ícone do Google */}
        <div className="text-center flex flex-col items-center gap-3 mt-2">
          <Link href="/cadastro" className="uppercase text-xs font-bold hover:underline">
